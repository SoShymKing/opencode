          ...
          if (
            ...
            const text =
              (input.overflow
                ...
                : "") +
              "Continue the existing task from the compaction summary. Do not treat this as a new request or restart planning, and do not expand its scope. Resume only the next unfinished step. If no steps remain, stop. Ask for clarification only if the existing task cannot proceed."
            yield* session.updatePart({
              id: PartID.ascending(),
