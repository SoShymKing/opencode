...
export const Definitions = {
  ...
  app_cycle_session_list_request_window: keybind("none", "Cycle session list request window"),
...
export const CommandMap = {
  ...
  app_cycle_session_list_request_window: "app.cycle.session_list_request_window",
