...
export const dict = {
  ...
  "command.session.archived.list": "Archivált munkamenetek",
  ...
  "dialog.archivedSessions.loading": "Archivált munkamenetek betöltése",
  "dialog.archivedSessions.archived": "Archiválva {{time}}",
  "dialog.archivedSessions.updated": "Frissítve {{time}}",
  "dialog.archivedSessions.restore": "Visszaállítás",
  "dialog.archivedSessions.restoring": "Visszaállítás...",
  ...
  "toast.session.restore.success.title": "Munkamenet visszaállítva",
  "toast.session.restore.failed.title": "Nem sikerült visszaállítani a munkamenetet",
