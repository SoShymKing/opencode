...
export const dict = {
  ...
  "command.session.archived.list": "Archyvuoti seansai",
  ...
  "dialog.archivedSessions.loading": "Įkeliami archyvuoti seansai",
  "dialog.archivedSessions.archived": "Archyvuotas {{time}}",
  "dialog.archivedSessions.updated": "Atnaujintas {{time}}",
  "dialog.archivedSessions.restore": "Atkurti",
  "dialog.archivedSessions.restoring": "Atkuriama...",
  ...
  "toast.session.restore.success.title": "Seansas atkurtas",
  "toast.session.restore.failed.title": "Nepavyko atkurti seanso",
