export const dict = {
  ...
  "command.session.archived.list": "Arkistoidut istunnot",
  ...
  "dialog.archivedSessions.loading": "Ladataan arkistoituja istuntoja",
  "dialog.archivedSessions.archived": "Arkistoitu {{time}}",
  "dialog.archivedSessions.updated": "Päivitetty {{time}}",
  "dialog.archivedSessions.restore": "Palauta",
  "dialog.archivedSessions.restoring": "Palautetaan...",
  ...
  "toast.session.restore.success.title": "Istunto palautettu",
  "toast.session.restore.failed.title": "Istunnon palauttaminen epäonnistui",
