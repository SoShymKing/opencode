export const dict = {
  ...
  "command.session.archived.list": "Zarchiwizowane sesje",
  ...
  "dialog.archivedSessions.loading": "Ładowanie zarchiwizowanych sesji",
  "dialog.archivedSessions.archived": "Zarchiwizowano {{time}}",
  "dialog.archivedSessions.updated": "Zaktualizowano {{time}}",
  "dialog.archivedSessions.restore": "Przywróć",
  "dialog.archivedSessions.restoring": "Przywracanie...",
  ...
  "toast.session.restore.success.title": "Sesja przywrócona",
  "toast.session.restore.failed.title": "Nie udało się przywrócić sesji",
