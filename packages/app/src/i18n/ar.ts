export const dict = {
  ...
  "command.session.archived.list": "الجلسات المؤرشفة",
  ...
  "dialog.archivedSessions.loading": "جار تحميل الجلسات المؤرشفة",
  "dialog.archivedSessions.archived": "تمت الأرشفة {{time}}",
  "dialog.archivedSessions.updated": "تم التحديث {{time}}",
  "dialog.archivedSessions.restore": "استعادة",
  "dialog.archivedSessions.restoring": "جار الاستعادة...",
  ...
  "toast.session.restore.success.title": "تمت استعادة الجلسة",
  "toast.session.restore.failed.title": "فشلت استعادة الجلسة",
