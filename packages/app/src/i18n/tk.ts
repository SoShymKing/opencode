export const dict = {
  ...
  "command.session.archived.list": "Arhiwlenen sessiýalar",
  ...
  "dialog.archivedSessions.empty": "Arhiwlenen sessiýalar ýok",
  "dialog.archivedSessions.loading": "Arhiwlenen sessiýalar ýüklenýär",
  "dialog.archivedSessions.archived": "Arhiwlendi {{time}}",
  "dialog.archivedSessions.updated": "Täzelendi {{time}}",
  "dialog.archivedSessions.restore": "Dikelt",
  "dialog.archivedSessions.restoring": "Dikeldilýär...",
  ...
  "toast.session.restore.success.title": "Sessiýa dikeldildi",
  "toast.session.restore.failed.title": "Sessiýany dikeldip bolmady",
