export const dict = {
  ...
  "command.session.archived.list": "Gearchiveerde sessies",
  ...
  "dialog.archivedSessions.loading": "Gearchiveerde sessies laden",
  "dialog.archivedSessions.archived": "Gearchiveerd {{time}}",
  "dialog.archivedSessions.updated": "Bijgewerkt {{time}}",
  "dialog.archivedSessions.restore": "Herstellen",
  "dialog.archivedSessions.restoring": "Herstellen...",
  ...
  "toast.session.restore.success.title": "Sessie hersteld",
  "toast.session.restore.failed.title": "Kan sessie niet herstellen",
