export const dict = {
  ...
  "command.session.archived.list": "Archivované relace",
  ...
  "dialog.archivedSessions.loading": "Načítání archivovaných relací",
  "dialog.archivedSessions.archived": "Archivováno {{time}}",
  "dialog.archivedSessions.updated": "Aktualizováno {{time}}",
  "dialog.archivedSessions.restore": "Obnovit",
  "dialog.archivedSessions.restoring": "Obnovování...",
  ...
  "toast.session.restore.success.title": "Relace obnovena",
  "toast.session.restore.failed.title": "Obnovení relace se nezdařilo",
