export const dict = {
  ...
  "command.session.archived.list": "Sessões arquivadas",
  ...
  "dialog.archivedSessions.loading": "Carregando sessões arquivadas",
  "dialog.archivedSessions.archived": "Arquivada {{time}}",
  "dialog.archivedSessions.updated": "Atualizada {{time}}",
  ...
  "toast.session.restore.success.title": "Sessão restaurada",
  "toast.session.restore.failed.title": "Falha ao restaurar sessão",
