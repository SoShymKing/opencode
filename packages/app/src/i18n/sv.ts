export const dict = {
  ...
  "command.session.archived.list": "Arkiverade sessioner",
  ...
  "dialog.archivedSessions.search.placeholder": "Sök bland arkiverade sessioner",
  "dialog.archivedSessions.empty": "Inga arkiverade sessioner",
  "dialog.archivedSessions.loading": "Läser in arkiverade sessioner",
  "dialog.archivedSessions.archived": "Arkiverad {{time}}",
  "dialog.archivedSessions.updated": "Uppdaterad {{time}}",
  "dialog.archivedSessions.restore": "Återställ",
  "dialog.archivedSessions.restoring": "Återställer...",
  ...
  "toast.session.restore.success.title": "Sessionen har återställts",
  "toast.session.restore.failed.title": "Det gick inte att återställa sessionen",
