export const dict: Record<string, string> = {
  ...
  "command.session.archived.list": "अभिलेख गरिएका सत्रहरू",
  ...
  "dialog.archivedSessions.search.placeholder": "अभिलेख गरिएका सत्रहरू खोज्नुहोस्",
  "dialog.archivedSessions.empty": "अभिलेख गरिएका सत्रहरू छैनन्",
  "dialog.archivedSessions.loading": "अभिलेख गरिएका सत्रहरू लोड गर्दै",
  "dialog.archivedSessions.archived": "{{time}} अभिलेख गरियो",
  "dialog.archivedSessions.updated": "{{time}} अद्यावधिक गरियो",
  "dialog.archivedSessions.restore": "पुनर्स्थापित गर्नुहोस्",
  "dialog.archivedSessions.restoring": "पुनर्स्थापित गर्दै...",
  ...
  "toast.session.restore.success.title": "सत्र पुनर्स्थापित गरियो",
  "toast.session.restore.failed.title": "सत्र पुनर्स्थापित गर्न असफल भयो",
