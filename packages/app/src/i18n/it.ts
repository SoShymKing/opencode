export const dict = {
  ...
  "command.session.archived.list": "Sessioni archiviate",
  ...
  "dialog.archivedSessions.loading": "Caricamento delle sessioni archiviate",
  "dialog.archivedSessions.archived": "Archiviata {{time}}",
  "dialog.archivedSessions.updated": "Aggiornata {{time}}",
  "dialog.archivedSessions.restore": "Ripristina",
  "dialog.archivedSessions.restoring": "Ripristino...",
  ...
  "toast.session.restore.success.title": "Sessione ripristinata",
  "toast.session.restore.failed.title": "Impossibile ripristinare la sessione",
