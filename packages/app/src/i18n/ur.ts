export const dict = {
  ...
  "command.session.archived.list": "آرکائیو شدہ سیشنز",
  ...
  "dialog.archivedSessions.loading": "آرکائیو شدہ سیشنز لوڈ ہو رہے ہیں",
  "dialog.archivedSessions.archived": "{{time}} آرکائیو کیا گیا",
  "dialog.archivedSessions.updated": "{{time}} اپ ڈیٹ کیا گیا",
  "dialog.archivedSessions.restore": "بحال کریں",
  "dialog.archivedSessions.restoring": "بحال کیا جا رہا ہے...",
  ...
  "toast.session.restore.success.title": "سیشن بحال کر دیا گیا",
  "toast.session.restore.failed.title": "سیشن بحال کرنے میں ناکام",
