export const dict = {
  ...
  "command.session.archived.list": "Sesi yang diarsipkan",
  ...
  "dialog.archivedSessions.loading": "Memuat sesi yang diarsipkan",
  "dialog.archivedSessions.archived": "Diarsipkan {{time}}",
  "dialog.archivedSessions.updated": "Diperbarui {{time}}",
