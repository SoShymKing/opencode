export const dict = {
  ...
  "command.session.archived.list": "Arxivlənmiş sessiyalar",
  ...
  "dialog.archivedSessions.loading": "Arxivlənmiş sessiyalar yüklənir",
  "dialog.archivedSessions.archived": "{{time}} arxivləndi",
  "dialog.archivedSessions.updated": "{{time}} yeniləndi",
  "dialog.archivedSessions.restore": "Bərpa et",
  "dialog.archivedSessions.restoring": "Bərpa edilir...",
  ...
  "toast.session.restore.success.title": "Sessiya bərpa edildi",
  "toast.session.restore.failed.title": "Sessiya bərpa edilə bilmədi",
