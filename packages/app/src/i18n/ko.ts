export const dict = {
  ...
  "command.session.archived.list": "보관된 세션",
  ...
  "dialog.archivedSessions.loading": "보관된 세션 로딩 중",
  "dialog.archivedSessions.archived": "{{time}} 보관됨",
  "dialog.archivedSessions.updated": "{{time}} 업데이트됨",
  "dialog.archivedSessions.restore": "복원",
  "dialog.archivedSessions.restoring": "복원 중...",
  ...
  "toast.session.restore.success.title": "세션이 복원됨",
  "toast.session.restore.failed.title": "세션 복원 실패",
