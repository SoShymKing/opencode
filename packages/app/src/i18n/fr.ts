export const dict = {
  ...
  "command.session.archived.list": "Sessions archivées",
  ...
  "dialog.archivedSessions.loading": "Chargement des sessions archivées",
  "dialog.archivedSessions.archived": "Archivée {{time}}",
  "dialog.archivedSessions.updated": "Mise à jour {{time}}",
  "dialog.archivedSessions.restore": "Restaurer",
  "dialog.archivedSessions.restoring": "Restauration...",
  ...
  "toast.session.restore.success.title": "Session restaurée",
  "toast.session.restore.failed.title": "Échec de la restauration de la session",
