export const dict = {
  ...
  "command.session.archived.list": "Sessions arxivades",
  ...
  "dialog.archivedSessions.loading": "S'estan carregant les sessions arxivades",
  "dialog.archivedSessions.archived": "Arxivada {{time}}",
  "dialog.archivedSessions.updated": "Actualitzada {{time}}",
  "dialog.archivedSessions.restore": "Restaura",
  "dialog.archivedSessions.restoring": "S'està restaurant...",
  ...
  "toast.session.restore.success.title": "Sessió restaurada",
  "toast.session.restore.failed.title": "No s'ha pogut restaurar la sessió",
