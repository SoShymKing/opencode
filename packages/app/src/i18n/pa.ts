export const dict = {
  ...
  "command.session.archived.list": "آرکائیو کیتے سیشن",
  ...
  "dialog.archivedSessions.loading": "آرکائیو کیتے سیشن لوڈ ہو رہے نیں",
  "dialog.archivedSessions.archived": "{{time}} آرکائیو کیتا گیا",
  "dialog.archivedSessions.updated": "{{time}} اپ ڈیٹ کیتا گیا",
  "dialog.archivedSessions.restore": "بحال کرو",
  "dialog.archivedSessions.restoring": "بحال ہو رہیا اے...",
  ...
  "toast.session.restore.success.title": "سیشن بحال ہو گیا",
  "toast.session.restore.failed.title": "سیشن بحال کرن چ ناکامی ہوئی",
