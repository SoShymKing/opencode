export const dict = {
  ...
  "command.session.archived.list": "Αρχειοθετημένες συνεδρίες",
  ...
  "dialog.archivedSessions.loading": "Φόρτωση αρχειοθετημένων συνεδριών",
  "dialog.archivedSessions.archived": "Αρχειοθετήθηκε {{time}}",
  "dialog.archivedSessions.updated": "Ενημερώθηκε {{time}}",
  "dialog.archivedSessions.restore": "Επαναφορά",
  "dialog.archivedSessions.restoring": "Επαναφορά...",
  ...
  "toast.session.restore.success.title": "Η συνεδρία επαναφέρθηκε",
  "toast.session.restore.failed.title": "Αποτυχία επαναφοράς συνεδρίας",
