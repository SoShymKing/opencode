export const dict = {
  ...
  "command.session.archived.list": "Arhivirane seje",
  ...
  "dialog.archivedSessions.loading": "Nalaganje arhiviranih sej",
  "dialog.archivedSessions.archived": "Arhivirano {{time}}",
  "dialog.archivedSessions.updated": "Posodobljeno {{time}}",
  "dialog.archivedSessions.restore": "Obnovi",
  "dialog.archivedSessions.restoring": "Obnavljanje...",
  ...
  "toast.session.restore.success.title": "Seja obnovljena",
  "toast.session.restore.failed.title": "Seje ni bilo mogoče obnoviti",
