...
export const dict = {
  ...
  "command.session.archived.list": "Setur í geymslu",
  ...
  "dialog.archivedSessions.loading": "Hleður setum úr geymslu",
  "dialog.archivedSessions.archived": "Sett í geymslu {{time}}",
  "dialog.archivedSessions.updated": "Uppfært {{time}}",
  "dialog.archivedSessions.restore": "Endurheimta",
  "dialog.archivedSessions.restoring": "Endurheimtir...",
  ...
  "toast.session.restore.success.title": "Seta endurheimt",
  "toast.session.restore.failed.title": "Ekki tókst að endurheimta setu",
