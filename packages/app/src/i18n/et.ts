export const dict = {
  ...
  "command.session.archived.list": "Arhiveeritud seansid",
  ...
  "dialog.archivedSessions.loading": "Arhiveeritud seansside laadimine",
  "dialog.archivedSessions.archived": "Arhiveeritud {{time}}",
  "dialog.archivedSessions.updated": "Uuendatud {{time}}",
  "dialog.archivedSessions.restore": "Taasta",
  "dialog.archivedSessions.restoring": "Taastamine...",
  ...
  "toast.session.restore.success.title": "Seanss taastatud",
  "toast.session.restore.failed.title": "Seansi taastamine ebaõnnestus",
