export const dict = {
  ...
  "command.session.archived.list": "Sesiuni arhivate",
  ...
  "dialog.archivedSessions.loading": "Se încarcă sesiunile arhivate",
  "dialog.archivedSessions.archived": "Arhivată {{time}}",
  "dialog.archivedSessions.updated": "Actualizată {{time}}",
  "dialog.archivedSessions.restore": "Restaurează",
  "dialog.archivedSessions.restoring": "Se restaurează...",
  ...
  "toast.session.restore.success.title": "Sesiune restaurată",
  "toast.session.restore.failed.title": "Nu s-a putut restaura sesiunea",
