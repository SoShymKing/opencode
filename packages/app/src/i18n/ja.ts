export const dict = {
  ...
  "command.session.archived.list": "アーカイブ済みセッション",
  ...
  "dialog.archivedSessions.empty": "アーカイブ済みセッションがありません",
  "dialog.archivedSessions.loading": "アーカイブ済みセッションを読み込み中",
  "dialog.archivedSessions.archived": "{{time}}にアーカイブ済み",
  "dialog.archivedSessions.updated": "{{time}}に更新",
  "dialog.archivedSessions.restore": "復元",
  "dialog.archivedSessions.restoring": "復元中...",
  ...
  "toast.session.restore.success.title": "セッションを復元しました",
  "toast.session.restore.failed.title": "セッションの復元に失敗しました",
