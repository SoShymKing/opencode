export const dict = {
  ...
  "command.session.archived.list": "Արխիվացված նիստեր",
  ...
  "dialog.archivedSessions.loading": "Բեռնվում են արխիվացված նիստերը",
  "dialog.archivedSessions.archived": "Արխիվացվել է {{time}}",
  "dialog.archivedSessions.updated": "Թարմացվել է {{time}}",
  "dialog.archivedSessions.restore": "Վերականգնել",
  "dialog.archivedSessions.restoring": "Վերականգնվում է...",
  ...
  "toast.session.restore.success.title": "Նիստը վերականգնվել է",
  "toast.session.restore.failed.title": "Չհաջողվեց վերականգնել նիստը",
