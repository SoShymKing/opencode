export const dict = {
  ...
  "command.session.archived.list": "Phiên đã lưu trữ",
  ...
  "dialog.archivedSessions.empty": "Không có phiên nào được lưu trữ",
  "dialog.archivedSessions.loading": "Đang tải phiên đã lưu trữ",
  "dialog.archivedSessions.archived": "Đã lưu trữ {{time}}",
  "dialog.archivedSessions.updated": "Đã cập nhật {{time}}",
  "dialog.archivedSessions.restore": "Khôi phục",
  "dialog.archivedSessions.restoring": "Đang khôi phục...",
  ...
  "toast.session.restore.success.title": "Đã khôi phục phiên",
  "toast.session.restore.failed.title": "Không thể khôi phục phiên",
