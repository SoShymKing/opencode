...
export const dict = {
  ...
  "command.session.archived.list": "Archivierte Sitzungen",
  ...
  "dialog.archivedSessions.loading": "Archivierte Sitzungen werden geladen",
  "dialog.archivedSessions.archived": "Archiviert {{time}}",
  "dialog.archivedSessions.updated": "Aktualisiert {{time}}",
  "dialog.archivedSessions.restore": "Wiederherstellen",
  "dialog.archivedSessions.restoring": "Wird wiederhergestellt...",
  ...
  "toast.session.restore.success.title": "Sitzung wiederhergestellt",
  "toast.session.restore.failed.title": "Sitzung konnte nicht wiederhergestellt werden",
