export const dict = {
  ...
  "command.session.archived.list": "Arhivētās sesijas",
  ...
  "dialog.archivedSessions.loading": "Notiek arhivēto sesiju ielāde",
  "dialog.archivedSessions.archived": "Arhivēta {{time}}",
  "dialog.archivedSessions.updated": "Atjaunināta {{time}}",
  "dialog.archivedSessions.restore": "Atjaunot",
  "dialog.archivedSessions.restoring": "Atjauno...",
  ...
  "toast.session.restore.success.title": "Sesija atjaunota",
  "toast.session.restore.failed.title": "Neizdevās atjaunot sesiju",
