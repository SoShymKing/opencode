export const dict = {
  ...
  "command.session.archived.list": "Arkiveraðar setur",
  ...
  "dialog.archivedSessions.search.placeholder": "Leita eftir arkiveraðum setum",
  "dialog.archivedSessions.empty": "Ongar arkiveraðar setur",
  "dialog.archivedSessions.loading": "Heintar arkiveraðar setur",
  "dialog.archivedSessions.archived": "Arkiverað {{time}}",
  "dialog.archivedSessions.updated": "Dagførd {{time}}",
  "dialog.archivedSessions.restore": "Endurstovna",
  "dialog.archivedSessions.restoring": "Endurstovnar...",
  ...
  "toast.session.restore.success.title": "Setan endurstovnað",
  "toast.session.restore.failed.title": "Tað eydnaðist ikki at endurstovna setuna",
